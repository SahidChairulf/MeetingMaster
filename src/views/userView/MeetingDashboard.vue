        ...
        <div class="px-5 lg:mt-6 mt-2">
            ...
            <div class="grid grid-cols-2 gap-2 mt-4">
                ...
                <div class="flex items-center shadow justify-between px-8 h-32 bg-blue-500 rounded-lg dark:bg-darker">
                    <div>
                        ...
                        <span class="text-3xl font-semibold text-white">{{ scheduledMeetings }}</span>
                        <span class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                            +2.6%
                        </span>
                    </div>
            ...
            <div class="flex flex-wrap -mx-6">
                <div class="w-full max-w-full mx-auto">
                    <div
                        class="relative flex-[1_auto] flex flex-col break-words min-w-0 border bg-white rounded-lg bg-purple-150 m-5">
                        <div
                            class="relative flex flex-col min-w-0 break-words bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            <!-- card header -->
                            <div
                                class="hidden px-9 pt-5 lg:flex justify-between items-stretch flex-wrap min-h-[70px] pb-0 bg-transparent">
                                <h3
                            ...
                            <!-- end card header -->
                            <div class="flex-auto block py-8 pt-6 px-9 overflow-y-scroll h-auto">
                                    ...
                                    <table class="w-full my-0 align-middle text-dark border-neutral-200 ">
                                        ...
                                        <tbody>
                                            <tr class="border-b border-dashed last:border-b-0"
                                                ...
                                                <td class="p-3 pr-0 text-end cursor-pointer">
                                                    <RouterLink to="/user-dashboard-meeting-details"
                                ...
                                <form>
                                    ...
                                    <div class="grid grid-cols-1 gap-1 lg:grid-cols-2 lg:gap-2 lg:mt-4 mt-2">
                                        ...
                                        <div class="grid grid-cols-1 gap-6">
                                            ...
                                            <div class="grid grid-cols-1 mb-32">
                                                <div>
                                                    <label
                                                        class="text-slate-700 dark:text-purple-200 font-bold uppercase">Meeting
                                                        Address</label>
                                                ...
                                                <!-- <label
                                                    class="text-slate-300 dark:text-purple-200 font-bold mt-2 uppercase">Meeting
                                                    Evaluasi</label>
                                    ...
                                    <div class="flex mx-auto space-x-2 justify-end mt-6">
                                        <button @click="addNewMeeting"
                                            class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600">Add</button>
...
export default {
    ...
    computed: {
        ...
        dataMeeting() {
         ...
         // Fungsi untuk memfilter pertemuan yang dijadwalkan
        scheduledMeetings() {
    ...
    methods: {
        ...
        async addNewMeeting() {
            ...
            // Menambahkan tanggal dan waktu ke dalam newMeetingData
            ...
            try {
                await this.addMeeting(newMeetingData);
        ...
        async editMeeting(meetingId) {
            // Temukan pertemuan yang akan diedit berdasarkan ID
            const meetingToEdit = this.getMeetings.find(meeting => meeting.id === meetingId);
            if (!meetingToEdit) {
                alert('Meeting not found');
                return;
            }

            // Set nilai input fields ke nilai pertemuan yang akan diedit
            this.meeting_title = meetingToEdit.Meeting.meeting_title;
            this.meeting_deskripsi = meetingToEdit.Meeting.meeting_deskripsi;
            this.meeting_kategori = meetingToEdit.Meeting.meeting_kategori;
            this.meeting_status = meetingToEdit.Meeting.meeting_status;
            this.date = new Date(meetingToEdit.Meeting.meeting_schedule);
            this.meeting_address = meetingToEdit.Meeting.meeting_address;
            this.meeting_evaluation = meetingToEdit.Meeting.meeting_evaluation;

            // Simpan ID pertemuan yang sedang diedit
            this.MeetingId = meetingId;
        },
